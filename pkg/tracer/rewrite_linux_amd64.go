...
// Ret returns the syscall result register and whether the call succeeded
// (amd64 uses the negative-errno convention).
func (r *SyscallRegs) Ret() (uintptr, bool) {
	return uintptr(r.regs.Rax), int64(r.regs.Rax) >= 0
}
